...
def saveplot(tensors, name, figsize=(20,20), *args, **kwargs):
	try:
		tensors = tensors.detach().cpu()
	except:
		pass
...
import glob
def save_depth_map_gray_scale():
    os.chdir('/content/depthMap')
...
def save_mask_gray_scale():
    os.chdir('/content/bg_fg_mask_1')
    filelist = glob.glob('*.jpg')
    for i in filelist:
        # print(i)
        im = Image.open(i).convert('L')
